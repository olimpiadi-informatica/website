...
| **SEDE**      | **PROVINCE ASSEGNATE**               | **ATLETI**     | **ISTITUTO**                            | **COMUNE**    | **PROV.** | **REFERENTE**                  | **E-MAIL REFERENTE**                                                                  |
| ------------- | ------------------------------------ | --- | --------------------------------------- | ------------- | --------- | ------------------------------ | ------------------------------------------------------------------------------------- |
...
| **CAM1**      | CE-BN-NA (Esclusa C. Stabia)     | 34  | Università di Napoli Sede di Agnano | Napoli        | NA        | Prof.re Lucio Pianese          | \-                                                                                    |
| **CAM2**      | AV-SA (Inclusa C. Stabia)        | 17  | ITI "B. Focaccia"                       | Salerno       | SA        | Prof. Agostino Clavelli        | [agostino.clavelli@istruzione.it](mailto:agostino.clavelli@istruzione.it)             |
...
| **LOM1**      | LO-PV-MI (escluso Rho e Legnano) | 25  | IIS "Enrico Mattei"                     | San Donato M. | MI        | Prof. Luca Mazzei              | [lmazzei@libero.it](mailto:lmazzei@libero.it)                                         |
