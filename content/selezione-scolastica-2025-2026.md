...
* **essere del triennio e avere almeno 65 punti.**

Sono inoltre ammessi di diritto alle prossime selezioni territoriali i 37 partecipanti delle scorse selezioni nazionali ancora ammissibili, e i membri delle squadre finaliste delle [OIS](https://sites.google.com/aldini.istruzioneer.it/olimpiadi-informatica-squadre/homepage) di quest'anno. Indipendentemente dal criterio per cui uno studente è ammissibile alle selezioni territoriali, dovrà in ogni caso:

- iscriversi su [olimpiadi-scientifiche](https://olimpiadi-scientifiche.it), associando il suo risultato correttamente;
- fare l'allenamento pre-territoriale, ottenendo un minimo di **50 punti**.

L'allenamento pre-territoriale sarà disponibile on-line dal 15 gennaio al 23 febbraio 2026 e si configura come un allenamento per coloro che risultano ammissibili alla gara territoriale per i criteri sopracitati.
